        ...
        <div className="p-8 max-w-7xl mx-auto space-y-6">
          <div className="flex justify-between items-end border-b border-gray-200 pb-4">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Ghi nhận sự cố vận hành và xử lý đền bù thiết bị.</p>
            </div>
            ...
            <div className="bg-gray-200 p-1 rounded-xl flex gap-1 shadow-inner">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
                  activeTab === "incidents" ? "bg-white text-indigo-600 shadow-sm" : "text-gray-500"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
                  activeTab === "compensations" ? "bg-white text-indigo-600 shadow-sm" : "text-gray-500"
                }`}
              >
          ...
          <div className="min-h-[500px]">
            {activeTab === "incidents" ? <IncidentListTab /> : <CompensationListTab />}
          </div>
        </div>
      </div>
    </div>
