...
import { verifyToken, isManager, isCustomer, isAdmin, isEmployee } from "../../../shared/middleware/authMiddleware.js";
...
router.get("/available", verifyToken, isEmployee, controller.getAvailableVouchers);
